...
const otpController = {
    ...
    async send(req, res, next) {
        ...
        try {
            ...
            let success;
            const data = { userName: user.userName, type, otp: otp.toString(), email, lenderName: "", lenderEmail: "", subject: "Regarding OTP", company: "Tech Developers", adminId: `${EMAIL_ADMIN_ID}`, password: `${EMAIL_ADMIN_PASSWORD}` }
